...
questAddReward(cid, topos, 2500, 1, item.uid) --amazon armor

elseif item.uid == 6052 then
questAddReward(cid, topos, 2452, 1, item.uid) --heavy mace

elseif item.uid == 6053 then
questAddReward(cid, topos, 2273, 171, item.uid) --UH 173

elseif item.uid == 6054 then
questAddReward(cid, topos, 1985, 1, item.uid) --grey tome

--warlock area II
elseif item.uid == 6055 then
questAddReward(cid, topos, 2184, 1, item.uid) --crystal wand

--trolls turim
elseif item.uid == 6056 then
questAddReward(cid, topos, 2524, 1, item.uid) --ornamented shield
...
questAddReward(cid, topos, 2475, 1, item.uid) --warrior helmet
...
questAddReward(cid, topos, 2465, 1, item.uid) --brass armor
...
questAddReward(cid, topos, 2533, 1, item.uid) --griffin shield

--morgaroth area
elseif item.uid == 6067 then
QUEST_ITEM = 2091 --golden key
QUEST_ACTION = 5005
rewardWeight = getItemWeight(QUEST_ITEM)
local DESCRIPTIONS = getItemDescriptions(QUEST_ITEM)
queststatus = getPlayerStorageValue(cid,item.uid)
...
questAddReward(cid, topos, 2509, 1, item.uid) --steel shield

elseif item.uid == 6069 then
questAddReward(cid, topos, 2648, 1, item.uid) --chain legs

elseif item.uid == 6070 then
questAddReward(cid, topos, 2464, 1, item.uid) --chain armor

elseif item.uid == 6071 then
questAddReward(cid, topos, 2456, 1, 6071) --bow

elseif item.uid == 6072 then
questAddReward(cid, topos, 2419, 1, 6071) --scimitar

elseif item.uid == 6073 then
questAddReward(cid, topos, 2394, 1, 6071) --morning star

elseif item.uid == 6074 then
questAddReward(cid, topos, 2428, 1, 6071) --orcish axe

--old silver mace
elseif item.uid == 6075 then
questAddReward(cid, topos, 2424, 1, item.uid) --silver mace
