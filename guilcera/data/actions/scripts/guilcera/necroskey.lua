...
if item.uid == 8015 and item.itemid == 1945 and getgate.itemid == 3698 and getgate2.itemid == 3698 and getgate3.itemid == 3700 and getgate4.itemid == 3700 and getgate5.itemid == 3698 and getgate6.itemid == 3698 and getgate7.itemid == 3700 then
 doTransformItem(item.uid,item.itemid+1)
 doCreateItem(2092,1,keypos)
 key = getThingfromPos(keypos)
 doSetItemActionId(key.uid,5004)
elseif item.uid == 8015 and item.itemid == 1946 then
 doPlayerSendCancel(cid,"Someone already pulled it.")
else
