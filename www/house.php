...
<img src="layout/images/titles/t_houses.png"/><p>
<?php
if ($config['log_ip']) {
...
if ($house !== false && $config['TFSVersion'] === 'OTH') {
	...
	*/
	...
	?>
	<span style="position: absolute;margin-left:30px;margin-top:10px;"><img style="max-width: 100px; max-height: 100px;" src="<?php house_exists(sanitize($house['name'])); ?>"/></span>
