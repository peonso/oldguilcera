<?php
	...
	function getClock($time = false, $format = false, $adjust = true) {
		...
		$date = "d M Y, H:i"; // 15 July 2013, 13:50
	...
	*/
	...
	$config['house'] = array(
			'house_file' => 'C:\Users\peonso\Desktop\otserv\guilcera\data\world\guilcera-house.xml',
