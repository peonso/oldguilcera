...
if(!defined('INITIALIZED'))
	...
	$main_content .= '<img src="layouts/guilcera_layout/img/titles/t_creacc.png"/><p>';
...
function EmailStateChanged() 
{
	...
	$main_content .= 'To play on '.htmlspecialchars($config['server']['serverName']).' you need an account. 
						...
						<TR><TD BGCOLOR="'.$config['site']['vdarkborder'].'" CLASS=white><B><font color="white">Create an '.htmlspecialchars($config['server']['serverName']).' Account</font></B></TD></TR>
						<TR><TD BGCOLOR="'.$config['site']['darkborder'].'"><TABLE BORDER=0 CELLSPACING=8 CELLPADDING=0>
						  <TR><TD>
						    <TABLE BORDER=0 CELLSPACING=5 CELLPADDING=0>';
	$main_content .= '<TR><TD width="150" valign="top"><B>Account name: </B></TD><TD colspan="2"><INPUT id="account_name" NAME="reg_name" onkeyup="checkAccount();" VALUE="" SIZE=30 MAXLENGTH=7 ><BR><font size="1" face="verdana,arial,helvetica">(Please enter your new account name)</font></TD></TR>
	...
	$main_content .= '</TEXTAREA>
					...
					<TABLE BORDER=0 WIDTH=100%>
					  <TR><TD ALIGN=center>
						...
						<INPUT TYPE=image NAME="I Agree" SRC="'.$layout_name.'/img/buttons/sbutton_iagree.png" BORDER=0 WIDTH=120 HEIGHT=18>
					    </FORM>
					  </TD><TD ALIGN=center>
					    <FORM  ACTION="?subtopic=latestnews" METHOD=post>
						<INPUT TYPE=image NAME="Cancel" SRC="'.$layout_name.'/img/buttons/sbutton_cancel.png" BORDER=0 WIDTH=120 HEIGHT=18>
					    </FORM>
					  </TD><TD ALIGN=center>
