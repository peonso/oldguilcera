...
if(!defined('INITIALIZED'))
	exit;
		...
		$main_content .= '<img src="layouts/guilcera_layout/img/titles/t_guilds.png"/><p>';
...
if($action == '')
{
	...
	if(count($guilds_list) > 0)
	{
		foreach($guilds_list as $guild)
		{
			...
			<INPUT TYPE=image NAME="View" ALT="View" SRC="'.$layout_name.'/img/buttons/sbutton_view.png" BORDER=0 WIDTH=120 HEIGHT=18>
			</TD></TR></FORM></TABLE>
			</TD></TR>';
		}
	}
		...
		<INPUT TYPE=image NAME="Create Guild" ALT="Create Guild" SRC="'.$layout_name.'/img/buttons/sbutton_createguild.png" BORDER=0 WIDTH=120 HEIGHT=18>
		</TD></TR></FORM></TABLE></TD></TR>';
	$main_content .= '</TABLE><br><br>';
	if($logged)
		$main_content .= '<TABLE BORDER=0 WIDTH=700px><TR><TD ALIGN=center><IMG SRC="'.$layout_name.'/images/blank.gif" WIDTH=80 HEIGHT=1 BORDER=0<BR></TD><TD ALIGN=center><TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0><FORM ACTION="?subtopic=guilds&action=createguild" METHOD=post><TR><TD>
		<INPUT TYPE=image NAME="Create Guild" ALT="Create Guild" SRC="'.$layout_name.'/img/buttons/sbutton_createguild.png" BORDER=0 WIDTH=120 HEIGHT=18>
		...
		<INPUT TYPE=image NAME="Login" ALT="Login" SRC="'.$layout_name.'/img/buttons/sbutton_login.png" BORDER=0 WIDTH=120 HEIGHT=18>
		</TD></TR></FORM></TABLE></TD><TD ALIGN=center><IMG SRC="'.$layout_name.'/images/blank.gif" WIDTH=80 HEIGHT=1 BORDER=0<BR></TD></TR></TABLE>';
}
//-----------------------------------------------------------------------------//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------//-----------------------------------------------------------------------------
...
if($action == 'show')
{
	...
	else
	{
		...
		if($guild_leader)
			$main_content .= '&nbsp;&nbsp;&nbsp;<a href="?subtopic=guilds&action=manager&guild='.$guild_id.'"><IMG SRC="'.$layout_name.'/img/buttons/sbutton_manageguild.png" BORDER=0 WIDTH=120 HEIGHT=18 alt="Manage Guild"></a>';
		$main_content .= '<BR><BR>
		...
		$main_content .= '<BR><BR>
		<TABLE BORDER=0 style="width:700px;align:center"><TR>';
		if(!$logged)
			$main_content .= '<TD ALIGN=center><TABLE width=100% BORDER=0 CELLSPACING=0 CELLPADDING=0><FORM ACTION="?subtopic=guilds&action=login&guild='.$guild_id.'&redirect=guild" METHOD=post><TR><TD>
			<INPUT TYPE=image NAME="Login" ALT="Login" SRC="'.$layout_name.'/img/buttons/sbutton_login.png" BORDER=0 WIDTH=120 HEIGHT=18>
			</TD></TR></FORM></TABLE></TD>';
		else
		{
			if($show_accept_invite > 0)
				...
				<INPUT TYPE=image NAME="Accept Invite" ALT="Accept Invite" SRC="'.$layout_name.'/img/buttons/sbutton_acceptinvite.png" BORDER=0 WIDTH=120 HEIGHT=18>
				</TD></TR></FORM></TABLE></TD>';
			if($guild_vice)
			{
				...
				<INPUT TYPE=image NAME="Invite Player" ALT="Invite Player" SRC="'.$layout_name.'/img/buttons/sbutton_inviteplayer.png" BORDER=0 WIDTH=120 HEIGHT=18>
				</TD></TR></FORM></TABLE></TD>';
				...
				<INPUT TYPE=image NAME="Change Rank" ALT="Change Rank" SRC="'.$layout_name.'/img/buttons/sbutton_changerank.png" BORDER=0 WIDTH=120 HEIGHT=18>
				</TD></TR></FORM></TABLE></TD>';
			}
			if($players_from_account_in_guild > 0)
				...
				<INPUT TYPE=image NAME="Leave Guild" ALT="Leave Guild" SRC="'.$layout_name.'/img/buttons/sbutton_leaveguild.png" BORDER=0 WIDTH=120 HEIGHT=18>
				</TD></TR></FORM></TABLE></TD>';
		}
		...
		<INPUT TYPE=image NAME="Back" ALT="Back" SRC="'.$layout_name.'/img/buttons/sbutton_back.png" BORDER=0 WIDTH=120 HEIGHT=18>
		</TD></TR></FORM></TABLE>
...
if($action == 'changerank')
{
	...
	if($guild_vice)
	{
		...
		$main_content .= '</SELECT>&nbsp;&nbsp;&nbsp;<INPUT TYPE=image NAME="Submit" ALT="Submit" SRC="'.$layout_name.'/img/buttons/sbutton_submit.png" BORDER=0 WIDTH=120 HEIGHT=18></TD><TR>
		</TABLE></FORM><TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0 width=100%><FORM ACTION="?subtopic=guilds&action=show&guild='.$guild_id.'" METHOD=post><TR><TD><center><INPUT TYPE=image NAME="Back" ALT="Back" SRC="'.$layout_name.'/img/buttons/sbutton_back.png" BORDER=0 WIDTH=120 HEIGHT=18></center></TD></TR></FORM></TABLE>';
	}
	else
		$main_content .= 'Error. You are not a leader or vice leader in guild '.htmlspecialchars($guild->getName()).'.<FORM ACTION="?subtopic=guilds&action=show&guild='.$guild_id.'" METHOD=post><INPUT TYPE=image NAME="Back" ALT="Back" SRC="'.$layout_name.'/img/buttons/sbutton_back.png" BORDER=0 WIDTH=120 HEIGHT=18></FORM>';
	}
}
...
if($action == 'acceptinvite')
{
	...
	else
	{
		...
		else
		{
			...
			$main_content .= '<br><INPUT TYPE=image NAME="Submit" ALT="Submit" SRC="'.$layout_name.'/img/buttons/sbutton_submit.png" BORDER=0 WIDTH=120 HEIGHT=18></form></TD></TR></TABLE><br/><center><TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0 width=100%><TR><FORM ACTION="?subtopic=guilds&action=show&guild='.$guild_id.'" METHOD=post><TD><INPUT TYPE=image NAME="Back" ALT="Back" SRC="'.$layout_name.'/img/buttons/sbutton_back.png" BORDER=0 WIDTH=120 HEIGHT=18></TD></TR></FORM></TABLE></center>';
		}
	}
}
...
if($action == 'leaveguild')
{
	...
	else
	{
		...
		else
		{
			...
			if(count($array_of_player_ig) > 0)
				$main_content .= '<td width="130" valign="top"><INPUT TYPE=image NAME="Submit" ALT="Submit" SRC="'.$layout_name.'/img/buttons/sbutton_submit.png" BORDER=0 WIDTH=120 HEIGHT=18></form></td>';
			$main_content .= '<td><FORM ACTION="?subtopic=guilds&action=show&guild='.$guild_id.'" METHOD=post><INPUT TYPE=image NAME="Back" ALT="Back" SRC="'.$layout_name.'/img/buttons/sbutton_back.png" BORDER=0 WIDTH=120 HEIGHT=18></FORM></td></tr></table>';
		}
	}
}
	...
	else
	{
		...
		<TABLE BORDER=0 width=100%>
		  <TR><TD ALIGN=center>
		    ...
		    <INPUT TYPE=image NAME="Submit" SRC="'.$layout_name.'/img/buttons/sbutton_submit.png" BORDER=0 WIDTH=120 HEIGHT=18>
		    </FORM>
		  </TD><TD ALIGN=center>
		...
		if($logged)
		{
			...
			if($guild_leader)
			{
				...
				foreach($rank_list as $rank)
				{
					...
					$main_content .= '<tr bgcolor="'.$bgcolor.'"><td align="center"><a href="?subtopic=guilds&guild='.$guild_id.'&action=deleterank&rankid='.urlencode($rank->getId()).'" border="0"><img src="'.$layout_name.'/img/buttons/sbutton_delete.png" border="0" alt="Delete Rank"></a></td><td><input type="text" name="'.htmlspecialchars($rank->getId()).'_name" value="'.htmlspecialchars($rank->getName()).'" size="35"></td><td align="center"><input type="radio" name="'.$rank->getId().'_level" value="3"';
					if($rank->getLevel() == 3)
				...
				$main_content .= '<br/><center><form action="?subtopic=guilds&action=show&guild='.$guild_id.'" METHOD=post><div class="BigButton" style="background-image:url('.$layout_name.'/img/buttons/sbutton.gif)" ><div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url('.$layout_name.'/img/buttons/sbutton_over.gif);" ></div><input type="image" name="Back" alt="Back" src="'.$layout_name.'/img/buttons/sbutton_back.png" ></div></div></form></center>';
			}
			else
