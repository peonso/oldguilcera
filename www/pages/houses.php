...
if(!defined('INITIALIZED'))
	exit;
		...
		$main_content .= '<img src="layouts/guilcera_layout/img/titles/t_houses.png"/><p>';
...
$main_content .= '</td></tr>';
$main_content .= '<tr><td colspan="3" style="text-align:right"><input type="image" name="Submit" alt="Submit" src="'.$layout_name.'/img/buttons/sbutton_submit.png"></td></tr></table></form>';
