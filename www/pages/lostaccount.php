...
if(!defined('INITIALIZED'))
	...
	$main_content .= '<img src="layouts/guilcera_layout/img/titles/t_lostacc.png"/><p>';
...
if($config['site']['send_emails'])
{
	...
	$main_content .= 'Account maker is not configured to send e-mails, you can\'t use Lost Account Interface. Contact a admin to get help.';