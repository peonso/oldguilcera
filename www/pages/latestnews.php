...
$main_content .= '<img src="layouts/guilcera_layout/img/titles/t_news.png"/><p>';
...
function showPost($topic, $text, $smile)
{
    ...
    if(isset($last_threads[0]))
    {
        ...
        {
            $main_content .= '<tr><td><b><font style="font-size:9px">' . date('l, d M Y', $thread['post_date']) . '</font></b></td></tr>';
            $main_content .= '<tr><td class="t_g">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>' . htmlspecialchars($thread['post_topic']) . '</a></td></tr>';
            $main_content .= '<tr><td style="padding:15px 20px 10px 10px;text-align:justify;" colspan="2">' . showPost('', $thread['post_text'], $thread['post_smile']) . '</td></tr>';
			$main_content .= '<tr><td><b><font style="font-size:9px">by <a href="?subtopic=characters&name='. urlencode($thread['name']) .'">'. htmlspecialchars($thread['name']) .'</a></b></font></td><td style="text-align:right; font-size:9px; vertical-align:bottoms;padding:0px 10px 0px 0px"><a href="?subtopic=forum&action=show_thread&id=' . $thread['id'] . '"><b>» Comment on this news</a></b></td></tr>';
			$main_content .= '<tr><td><br></td></tr>';
			/*$main_content .= '<tr style="background-color:black;width:100%;height:1px"><td colspan="2"></td></tr>';*/
			$main_content .= '<tr><td><br></td></tr>';
        }
        $main_content .= '</table>';
    }
