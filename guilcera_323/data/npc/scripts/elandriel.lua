...
if string.find(msg, '(%a*)offer(%a*)') and cid == focus then
	selfSay('I sell blank runes, mana fluids, power bolts and burst arrows.')
end
...
if string.find(msg, '(%a*)burst arrow(%a*)') and cid == focus then
	selfSay('Do you want to buy 100 burst arrows for 5000 gold pieces?')
	talk_start = os.clock()
	itemid = 2546
	count = 100
	cost = 5000
...
if string.find(msg, '(%a*)power bolt(%a*)') and cid == focus then
	selfSay('Do you want to buy 100 bolts for 2000 gold pieces?')
	talk_start = os.clock()
	itemid = 2547
	count = 100
	cost = 2000
