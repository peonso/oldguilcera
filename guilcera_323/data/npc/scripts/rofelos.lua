...
if string.find(msg, 'hi') and string.len(msg) == 2 then
	...
	if(focus == 0) then
	selfSay('Hi, ' .. creatureGetName(cid) .. '! Are you new in Xanadu? I am Sam, I sell some equipments, ammunitions and food. If you want I can change your gold to platinum and platinum to crystal.')
	focus = cid
	end
	talk_start = os.clock()
end
