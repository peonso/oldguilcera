...
if string.find(msg, '(%a*)offer(%a*)') and cid == focus then
	selfSay('I am traveling to Peonsville, Taumel, Dodoma, Cona, Xanadu, and to Caralin.')
end
...
if string.find(msg, 'peonsville') and cid == focus then
	selfSay('Do you want to go to Peonsville for 50 gold pieces?')
	talk_start = os.clock()
	talkcount = 4
	boat = 1
	return
...
if string.find(msg, 'taumel') and cid == focus then
	selfSay('Do you want to go to Taumel for 100 gold pieces?')
	talk_start = os.clock()
	talkcount = 4
	boat = 2
	return
...
if string.find(msg, 'dodoma') and cid == focus then
	selfSay('Do you want to go to Dodoma for 150 gold pieces?')
	talk_start = os.clock()
	talkcount = 4
	boat = 3
	return
...
if string.find(msg, 'cona') and cid == focus then
	selfSay('Do you want to go to Cona for 150 gold pieces?')
	talk_start = os.clock()
	talkcount = 4
	boat = 4
	return
...
if string.find(msg, 'xanadu') and cid == focus then
	selfSay('Do you want to go to Xanadu for 50 gold pieces?')
	talk_start = os.clock()
	talkcount = 4
	boat = 5
	return
...
if string.find(msg, 'caralin') and cid == focus then
	selfSay('Do you want to go to Caralin for 100 gold pieces?')
	talk_start = os.clock()
	talkcount = 4
	boat = 7
	return
...
if boat == 1 then
	npcTeleport(cid,244,249,7,50,0)
	focus = 0
	talk_start = 0
	boat = 0
	selfSay('Good travel.')
...
if boat == 2 then
	npcTeleport(cid,311,38,7,100,0)
	focus = 0
	talk_start = 0
	boat = 0
	selfSay('Good travel.')
...
if boat == 3 then
	npcTeleport(cid,172,106,7,150,0)
	focus = 0
	talk_start = 0
	boat = 0
	selfSay('Good travel.')
...
if boat == 5 then
	npcTeleport(cid,416,459,7,50,0)
	focus = 0
	talk_start = 0
	boat = 0
	selfSay('Good travel.')
...
if boat == 7 then
	npcTeleport(cid,196,556,7,100,0)
	focus = 0
	talk_start = 0
	boat = 0
	selfSay('Good travel.')
