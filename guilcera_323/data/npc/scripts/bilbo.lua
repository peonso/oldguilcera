...
if string.find(msg, 'hi') and string.len(msg) == 2 then
	...
	if(focus == 0) then
	selfSay('Hi, ' .. creatureGetName(cid) .. '! Are you new in Bombera? I am Bilbo, I sell and buy some equipments. If you want I can change your gold to platinum and platinum to crystal.')
	focus = cid
	end
	talk_start = os.clock()
end
...
if string.find(msg, '(%a*)offer(%a*)') and cid == focus then
	selfSay('I am selling Shovel, Rope, Fishing Rod and Backpacks. And I also buy War Hammers, Maces, Swords and Brass Helmets.')
end

if string.find(msg, '(%a*)equip(%a*)') and cid == focus then
	selfSay('I am selling Shovel, Rope, Machete, Fishing Rod and Backpacks. And I also buy War Hammers, Maces, Swords and Brass Helmets.')
end
