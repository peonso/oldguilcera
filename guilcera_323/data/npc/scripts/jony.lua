...
if string.find(msg, '(%a*)offer(%a*)') and cid == focus then
	selfSay('I am traveling to Peonsville, Taumel, Cona, Xanadu, Caralin and Turim.')
end
...
if string.find(msg, 'cona') and cid == focus then
	selfSay('Do you want to go to Cona for 10 gold pieces?')
	talk_start = os.clock()
	talkcount = 4
	boat = 4
	return
